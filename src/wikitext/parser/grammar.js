    ...
    function formatArgs(argMap) {
      ...
      for (let argName in argMap) {
        ...
        if (argName === "boolParams") {
          ...
          if (
            typeof argMap[argName] === "object" &&
            argMap[argName].value !== undefined
          ) {
            argParts.push(
              displayName + "=&" + JSON.stringify(argMap[argName].value)
            );
          } else {
...
function peg$parse(input, options = {}) {
  ...
  function peg$a60(quotes) {
    ...
    var tsr = tsrOffsets();
    tsr[0] += plainticks;
    var mwq = new SelfclosingTagTk(
      "mw-quote",
      [new KV("value", quotes.substring(plainticks))],
      { tsr: tsr }
    );
    if (quotes.length > 2) {
  ...
  function peg$a62(il, sol_il) {
    ...
    if (lname !== "includeonly" && sol_il && il.constructor === TagTk) {
      ...
      var inclContent = dp.src.substring(
        dp.extTagOffsets[1] - dp.extTagOffsets[0],
        dp.extTagOffsets[2] - dp.extTagOffsets[0]
      );
  ...
  function peg$a82(p, target, params) {
    ...
    // again.
    params.unshift(
      new KV(tu.flattenIfArray(target.tokens), "", target.srcOffsets)
    );
  ...
  function peg$a95(proto, addr, path) {
    ...
    if (
      url.length === 1 &&
      url[0].constructor === String &&
      url[0].length <= proto.length
    ) {
  ...
  function peg$a97(r) {
    return [
      new SelfclosingTagTk("urllink", [new KV("href", r)], {
        tsr: tsrOffsets(),
      }),
    ];
  }
  ...
  function peg$a104(bullets, c, cpos, d) {
    ...
    li1Bullets.push(";");
    const li1 = new TagTk("listItem", [new KV("bullets", li1Bullets)], {
      tsr: tsr,
    });
    // TSR: -1 for the intermediate ":"
    const li2Bullets = bullets.slice();
    li2Bullets.push(":");
    const li2 = new TagTk("listItem", [new KV("bullets", li2Bullets)], {
      tsr: [cpos - 1, cpos],
      stx: "row",
    });
  ...
  function peg$a113(name, val) {
    if (val !== null) {
      if (val.value !== null) {
        ...
        return new KV(tu.flattenIfArray(name), "", [
          startOffset(),
          val.kEndPos,
          val.vStartPos,
          endOffset(),
  ...
  function peg$a128(lv0, f, ts, lv1) {
    ...
    return [
      new SelfclosingTagTk("language-variant", attribs, {
        tsr: [lv0, lv1],
        src: lvsrc,
  ...
  function peg$a143(tokens) {
    return {
      tokens: tu.flattenStringlist(tokens),
      srcOffsets: [startOffset(), endOffset()],
    };
  }
  ...
  function peg$a166(n, sp) {
    return {
      tokens: [n],
      srcOffsets: [startOffset(), endOffset() - sp.length],
    };
  }
  ...
  var maybeExtensionTag = function (t) {
    ...
    if (isInstalledExt) {
      ...
      var extContent = dp.src.substring(
        dp.extTagOffsets[1] - dp.extTagOffsets[0],
        dp.extTagOffsets[2] - dp.extTagOffsets[0]
      );
      var separateTokenizer = new PegTokenizer(tokenizer, env);
      separateTokenizer.setSourceOffsets(
        dp.extTagOffsets[1],
        dp.extTagOffsets[2]
      );
  ...
  function peg$parsestart(silence, param_preproc) {
    ...
    if (checkCache) {
      ...
      if (!peg$cache[bucket]) {
        ...
        if (cached) {
          ...
          if (cached.hasOwnProperty("$preproc"))
            param_preproc.value = cached.$preproc;
    ...
    if (checkCache) {
      ...
      if (saved_preproc !== param_preproc.value)
        cached.$preproc = param_preproc.value;
    }
    return r1;
  }
  function peg$parsetable_start_tag(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
      ...
      for (;;) {
        choice_2: {
          seq_2: {
            p8 = peg$currPos;
            p9 = peg$currPos;
            r10 = peg$discardinline_breaks(
              true,
              0x0,
              0,
              param_preproc,
              new peg$Reference(null)
            );
            if (r10 === peg$FAILED) {
              r10 = void 0;
            } else {
          ...
          r7 = peg$parsetplarg_or_template(
            true,
            0x0,
            0,
            new peg$Reference(null),
  ...
  function peg$parserow_syntax_table_args(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parsetable_attributes(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parsegeneric_newline_attributes(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    r1 = [];
    for (;;) {
      r2 = peg$parsegeneric_newline_attribute(
        true,
        boolParams,
        param_templatedepth,
        param_preproc,
  ...
  function peg$parsetplarg_or_template_or_bust(silence, param_preproc) {
    ...
    for (;;) {
      choice_1: {
        r4 = peg$parsetplarg_or_template(
          true,
          0x0,
          0,
          new peg$Reference(null),
      ...
      seq_2: {
        ...
        choice_1: {
          seq_3: {
            ...
            r13 = peg$parseextlink_preprocessor_text(
              true,
              boolParams | 0x4,
              param_templatedepth,
              param_preproc,
          ...
          choice_3: {
            r15 = peg$parseextlink_preprocessor_text(
              true,
              boolParams | 0x4,
              param_templatedepth,
              param_preproc,
  ...
  function peg$discardinline_breaks(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    seq_1: {
      ...
      seq_2: {
        ...
        peg$savedPos = peg$currPos;
        r6 = peg$a17(
          /*extTag*/ (boolParams & 0x800) !== 0,
          /*h*/ (boolParams & 0x2) !== 0,
          /*extlink*/ (boolParams & 0x4) !== 0,
          param_templatedepth,
          param_preproc.value,
          /*equal*/ (boolParams & 0x8) !== 0,
          /*table*/ (boolParams & 0x10) !== 0,
          /*templateArg*/ (boolParams & 0x20) !== 0,
          /*tableCellArg*/ (boolParams & 0x40) !== 0,
          /*semicolon*/ (boolParams & 0x80) !== 0,
          /*arrow*/ (boolParams & 0x100) !== 0,
          /*linkdesc*/ (boolParams & 0x200) !== 0,
          /*colon*/ (boolParams & 0x1000) !== 0,
          param_th.value
        );
        if (r6) {
          r6 = void 0;
  ...
  function peg$parsetplarg_or_template(
    silence,
    boolParams,
    param_templatedepth,
    param_th,
    ...
    seq_1: {
      ...
      r7 = peg$parsetplarg_or_template_guarded(
        silence,
        boolParams,
        param_templatedepth + 1,
        param_th,
        param_preproc
      );
      // t <- r7
  ...
  function peg$parsetable_attribute(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    seq_1: {
      ...
      r7 = peg$parsetable_attribute_name(
        silence,
        boolParams,
        param_templatedepth,
        param_preproc,
  ...
  function peg$parsegeneric_newline_attribute(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    seq_1: {
      ...
      r5 = peg$parsegeneric_attribute_name(
        silence,
        boolParams,
        param_templatedepth,
        param_preproc,
      ...
      seq_2: {
        ...
        r13 = peg$parsegeneric_att_value(
          silence,
          boolParams,
          param_templatedepth,
          param_preproc,
  ...
  function peg$parseextlink_preprocessor_text(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    r1 = peg$parseextlink_preprocessor_text_parameterized(
      silence,
      boolParams & ~0x200,
      param_templatedepth,
      param_preproc,
  ...
  function peg$parseblock(
    ...
    choice_1: {
      ...
      seq_1: {
        ...
        r7 = peg$parsecomment_or_includes(
          silence,
          boolParams,
          param_templatedepth,
          param_preproc,
  ...
  function peg$parsetplarg_or_template_guarded(
    silence,
    boolParams,
    param_templatedepth,
    param_th,
  ...
  function peg$parsetable_attribute_name(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parsetable_att_value(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    choice_1: {
      ...
      seq_1: {
        ...
        // free p6
        // free p5
        r8 = peg$parsetable_attribute_preprocessor_text_single(
          silence,
          boolParams,
          param_templatedepth,
          param_preproc,
      ...
      seq_3: {
        ...
        // free p11
        // free p6
        r13 = peg$parsetable_attribute_preprocessor_text_double(
          silence,
          boolParams,
          param_templatedepth,
          param_preproc,
      ...
      seq_5: {
        ...
        // free p11
        r16 = peg$parsetable_attribute_preprocessor_text(
          silence,
          boolParams,
          param_templatedepth,
          param_preproc,
  ...
  function peg$parsegeneric_attribute_name(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parsegeneric_att_value(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    choice_1: {
      ...
      seq_1: {
        ...
        // free p6
        // free p5
        r8 = peg$parseattribute_preprocessor_text_single(
          silence,
          boolParams,
          param_templatedepth,
          param_preproc,
      ...
      seq_4: {
        ...
        // free p10
        // free p6
        r15 = peg$parseattribute_preprocessor_text_double(
          silence,
          boolParams,
          param_templatedepth,
          param_preproc,
      ...
      seq_7: {
        ...
        // free p10
        r21 = peg$parseattribute_preprocessor_text(
          silence,
          boolParams,
          param_templatedepth,
          param_preproc,
  ...
  function peg$parseextlink_preprocessor_text_parameterized(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parseinline_element(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    choice_1: {
      ...
      seq_3: {
        ...
        // free p3
        r9 = peg$parselang_variant_or_tpl(
          silence,
          boolParams,
          param_templatedepth,
          param_th,
  ...
  function peg$parsecomment_or_includes(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parsesol(
    ...
    seq_1: {
      ...
      r4 = peg$parsecomment_or_includes(
        silence,
        boolParams,
        param_templatedepth,
        param_preproc,
  ...
  function peg$discardtplarg(
    ...
    var cached, bucket, key;
    if (checkCache) {
      key = [71, boolParams & 0x3bff, param_templatedepth, param_th.value]
        .map(String)
        .join(":");
      bucket = peg$currPos;
      if (!peg$cache[bucket]) {
  ...
  function peg$parsetemplate(
    ...
    var cached, bucket, key;
    if (checkCache) {
      key = [64, boolParams & 0x3bff, param_templatedepth, param_th.value]
        .map(String)
        .join(":");
      bucket = peg$currPos;
      if (!peg$cache[bucket]) {
  ...
  function peg$parsetplarg(silence, boolParams, param_templatedepth, param_th) {
    ...
    var cached, bucket, key;
    if (checkCache) {
      key = [70, boolParams & 0x3bff, param_templatedepth, param_th.value]
        .map(String)
        .join(":");
      bucket = peg$currPos;
      if (!peg$cache[bucket]) {
  ...
  function peg$discardwikilink(
    ...
    choice_1: {
      r1 = peg$discardwikilink_preproc(
        silence,
        boolParams,
        param_templatedepth,
        new peg$Reference("]]"),
  ...
  function peg$parsedirective(
    ...
    choice_1: {
      ...
      r1 = peg$parsetplarg_or_template(
        silence,
        boolParams,
        param_templatedepth,
        param_th,
      ...
      seq_1: {
        ...
        // free p3
        r5 = peg$parselang_variant_or_tpl(
          silence,
          boolParams,
          param_templatedepth,
          param_th,
  ...
  function peg$discardxmlish_tag(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parsetable_attribute_preprocessor_text_single(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parsetable_attribute_preprocessor_text_double(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parsetable_attribute_preprocessor_text(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parseattribute_preprocessor_text_single(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parseattribute_preprocessor_text_double(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parseattribute_preprocessor_text(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parselang_variant_or_tpl(
    silence,
    boolParams,
    param_templatedepth,
    param_th,
  ...
  function peg$parseinclude_limits(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parsetable_line(
    ...
    seq_1: {
      ...
      choice_2: {
        ...
        seq_3: {
          p5 = peg$currPos;
          r9 = peg$parsetable_content_line(
            silence,
            boolParams | 0x10,
            param_templatedepth,
            param_preproc,
  ...
  function peg$parsexmlish_tag_opened(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    seq_1: {
      ...
      r7 = peg$parsegeneric_newline_attributes(
        silence,
        boolParams & ~0x50,
        param_templatedepth,
        param_preproc,
  ...
  function peg$discardtplarg_preproc(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    seq_1: {
      ...
      r7 = peg$parsetemplate_param_value(
        silence,
        boolParams,
        param_templatedepth,
        param_preproc,
      ...
      for (;;) {
        seq_2: {
          ...
          choice_1: {
            ...
            // free p15
            r13 = peg$parsetemplate_param_value(
              silence,
              boolParams,
              param_templatedepth,
              param_preproc,
  ...
  function peg$parsetemplate_preproc(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parsetplarg_preproc(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$discardwikilink_preproc(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    seq_1: {
      ...
      r5 = peg$parsewikilink_preprocessor_text(
        silence,
        boolParams,
        param_templatedepth,
        param_preproc,
  ...
  function peg$discardbroken_wikilink(
    silence,
    boolParams,
    param_preproc,
    param_templatedepth,
  ...
  function peg$parseextension_tag(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
      ...
      seq_2: {
        ...
        for (;;) {
          choice_2: {
            ...
            r11 = peg$parsetplarg_or_template(
              silence,
              boolParams,
              param_templatedepth,
              param_th,
  ...
  function peg$parselang_variant(
    silence,
    boolParams,
    param_templatedepth,
    param_th,
    ...
    choice_1: {
      r1 = peg$parselang_variant_preproc(
        silence,
        boolParams,
        param_templatedepth,
        new peg$Reference("}-"),
  ...
  function peg$parsewikilink_preproc(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parsebroken_wikilink(
    silence,
    boolParams,
    param_preproc,
    param_templatedepth,
  ...
  function peg$parsedtdd(
    ...
    seq_1: {
      ...
      r15 = peg$parseinlineline_break_on_colon(
        silence,
        boolParams,
        param_templatedepth,
        param_preproc,
  ...
  function peg$parsehacky_dl_uses(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$discardsol(
    ...
    seq_1: {
      ...
      r4 = peg$discardcomment_or_includes(
        silence,
        boolParams,
        param_templatedepth,
        param_preproc,
  ...
  function peg$parsetable_content_line(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    seq_1: {
      ...
      // free r4
      choice_2: {
        r4 = peg$parsetable_heading_tags(
          silence,
          boolParams,
          param_templatedepth,
          param_preproc
  ...
  function peg$parsetemplate_param_value(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    p2 = peg$currPos;
    r3 = peg$parsetemplate_param_text(
      silence,
      boolParams & ~0x8,
      param_templatedepth,
      param_preproc,
  ...
  function peg$parsetemplate_param(
    ...
    choice_1: {
      ...
      seq_1: {
        p3 = peg$currPos;
        r4 = peg$parsetemplate_param_name(
          silence,
          boolParams,
          param_templatedepth,
          param_preproc,
        ...
        seq_2: {
          ...
          r15 = peg$parsetemplate_param_value(
            silence,
            boolParams,
            param_templatedepth,
            param_preproc,
  ...
  function peg$parsewikilink_preprocessor_text(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parsewikilink_content(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parselang_variant_preproc(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    seq_1: {
      ...
      choice_1: {
        ...
        seq_2: {
          ...
          r10 = peg$parseopt_lang_variant_flags(
            silence,
            boolParams,
            param_templatedepth,
            param_preproc,
      ...
      choice_2: {
        ...
        seq_4: {
          ...
          r16 = peg$parselang_variant_text(
            silence,
            boolParams,
            param_templatedepth,
            param_preproc,
        ...
        seq_5: {
          ...
          r19 = peg$parselang_variant_option_list(
            silence,
            boolParams,
            param_templatedepth,
            param_preproc,
  ...
  function peg$parseinlineline_break_on_colon(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$discardcomment_or_includes(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parsetable_heading_tags(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc
    ...
    var cached, bucket, key;
    if (checkCache) {
      key = [186, boolParams & 0x3bff, param_templatedepth, param_preproc.value]
        .map(String)
        .join(":");
      bucket = peg$currPos;
      if (!peg$cache[bucket]) {
    ...
    r1 = peg$parsetable_heading_tags_parameterized(
      silence,
      boolParams,
      param_templatedepth,
      param_preproc,
      new peg$Reference(true)
    );
    if (checkCache) {
      cached = peg$cache[bucket][key] = {
        nextPos: peg$currPos,
  ...
  function peg$parsetable_row_tag(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parsetable_data_tags(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parsetable_caption_tag(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    seq_1: {
      ...
      r7 = peg$parserow_syntax_table_args(
        silence,
        boolParams,
        param_templatedepth,
        param_preproc,
      ...
      r10 = [];
      for (;;) {
        r11 = peg$parsenested_block_in_table(
          silence,
          boolParams,
          param_templatedepth,
          param_preproc,
  ...
  function peg$parsetemplate_param_text(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    for (;;) {
      choice_1: {
        r4 = peg$parsenested_block(
          silence,
          (boolParams & ~0x54) | 0x20,
          param_templatedepth,
          param_preproc,
          param_th
        );
  ...
  function peg$parsetemplate_param_name(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parselink_text(
    ...
    r1 = peg$parselink_text_parameterized(
      silence,
      (boolParams & ~0x8) | 0x200,
      param_templatedepth,
      param_preproc,
      param_th
    );
  ...
  function peg$parseopt_lang_variant_flags(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    seq_1: {
      p5 = peg$currPos;
      r6 = peg$parselang_variant_flags(
        silence,
        boolParams,
        param_templatedepth,
        param_preproc,
  ...
  function peg$parselang_variant_text(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parselang_variant_option_list(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    choice_1: {
      ...
      seq_1: {
        p3 = peg$currPos;
        r4 = peg$parselang_variant_option(
          silence,
          boolParams,
          param_templatedepth,
          param_preproc,
        ...
        for (;;) {
          ...
          seq_2: {
            ...
            r10 = peg$parselang_variant_option(
              silence,
              boolParams,
              param_templatedepth,
              param_preproc,
      ...
      // free p3
      p3 = peg$currPos;
      r14 = peg$parselang_variant_text(
        silence,
        boolParams,
        param_templatedepth,
        param_preproc,
  ...
  function peg$discardinclude_limits(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parsetable_heading_tags_parameterized(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    seq_1: {
      ...
      for (;;) {
        ...
        seq_2: {
          ...
          r11 = peg$parsetable_heading_tag(
            silence,
            boolParams,
            param_templatedepth,
            param_preproc,
  ...
  function peg$parsetable_data_tag(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    seq_1: {
      ...
      // free p4
      r6 = peg$parserow_syntax_table_args(
        silence,
        boolParams,
        param_templatedepth,
        param_preproc,
      ...
      r8 = [];
      for (;;) {
        r9 = peg$parsenested_block_in_table(
          silence,
          boolParams,
          param_templatedepth,
          param_preproc,
      ...
      seq_1: {
        ...
        choice_1: {
          ...
          seq_2: {
            ...
            p9 = peg$currPos;
            r10 = peg$discardrow_syntax_table_args(
              true,
              boolParams,
              param_templatedepth,
              param_preproc,
  ...
  function peg$parsenested_block_in_table(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parsenested_block(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parselink_text_parameterized(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
      ...
      choice_1: {
        seq_1: {
          ...
          choice_2: {
            ...
            r7 = peg$parsefull_table_in_link_caption(
              silence,
              boolParams,
              param_templatedepth,
              param_preproc,
  ...
  function peg$parselang_variant_flags(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    choice_1: {
      ...
      seq_1: {
        ...
        seq_2: {
          ...
          r10 = peg$parselang_variant_flags(
            silence,
            boolParams,
            param_templatedepth,
            param_preproc,
  ...
  function peg$parselang_variant_option(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    choice_1: {
      ...
      seq_1: {
        ...
        // free p5
        choice_2: {
          r10 = peg$parselang_variant_nowiki(
            silence,
            boolParams,
            param_templatedepth,
            param_preproc,
          ...
          r10 = peg$parselang_variant_text_no_semi(
            silence,
            boolParams,
            param_templatedepth,
            param_preproc,
      ...
      seq_2: {
        ...
        // free p12
        choice_3: {
          r13 = peg$parselang_variant_nowiki(
            silence,
            boolParams,
            param_templatedepth,
            param_preproc,
          ...
          r13 = peg$parselang_variant_text_no_semi_or_arrow(
            silence,
            boolParams,
            param_templatedepth,
            param_preproc,
        ...
        // free p12
        r16 = peg$parselang_variant_name(
          silence,
          boolParams,
          param_templatedepth,
          param_preproc,
        ...
        // free p12
        choice_4: {
          r20 = peg$parselang_variant_nowiki(
            silence,
            boolParams,
            param_templatedepth,
            param_preproc,
          ...
          r20 = peg$parselang_variant_text_no_semi(
            silence,
            boolParams,
            param_templatedepth,
            param_preproc,
  ...
  function peg$parsetable_heading_tag(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    seq_1: {
      p3 = peg$currPos;
      r4 = peg$parserow_syntax_table_args(
        silence,
        boolParams,
        param_templatedepth,
        param_preproc,
  ...
  function peg$discardrow_syntax_table_args(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parsefull_table_in_link_caption(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    seq_1: {
      ...
      r6 = peg$parsefull_table_in_link_caption_parameterized(
        silence,
        (boolParams & ~0x200) | 0x10,
        param_templatedepth,
        param_preproc,
        param_th
      );
  ...
  function peg$parselang_variant_flag(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parselang_variant_name(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parselang_variant_nowiki(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parselang_variant_text_no_semi(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
  ...
  function peg$parselang_variant_text_no_semi_or_arrow(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
    ...
    r1 = peg$parselang_variant_text_no_semi(
      silence,
      boolParams | 0x100,
      param_templatedepth,
      param_preproc,
  ...
  function peg$parsefull_table_in_link_caption_parameterized(
    silence,
    boolParams,
    param_templatedepth,
    param_preproc,
        ...
        seq_2: {
          ...
          for (;;) {
            seq_3: {
              ...
              choice_1: {
                r14 = peg$parsetable_content_line(
                  silence,
                  boolParams,
                  param_templatedepth,
                  param_preproc,
                ...
                r14 = peg$parsetplarg_or_template(
                  silence,
                  boolParams,
                  param_templatedepth,
                  param_th,
  ...
  if (options.stream) {
    ...
    switch (peg$startRule) {
      ...
      case "table_start_tag":
        peg$result = peg$parsetable_start_tag(
          false,
          0,
          0,
          new peg$Reference(null),
      ...
      case "row_syntax_table_args":
        peg$result = peg$parserow_syntax_table_args(
          false,
          0,
          0,
          new peg$Reference(null),
      ...
      case "table_attributes":
        peg$result = peg$parsetable_attributes(
          false,
          0,
          0,
          new peg$Reference(null),
      ...
      case "generic_newline_attributes":
        peg$result = peg$parsegeneric_newline_attributes(
          false,
          0,
          0,
          new peg$Reference(null),
      ...
      case "tplarg_or_template_or_bust":
        peg$result = peg$parsetplarg_or_template_or_bust(
          false,
          new peg$Reference(null)
        );
        break;
...
export const DefaultTracer = peg$DefaultTracer;
